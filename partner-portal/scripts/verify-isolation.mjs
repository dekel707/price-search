...
for (const value of ["TEAM_PORTAL_DATABASE_URL", "TEAM_PORTAL_OWNER_PIN", "TEAM_PORTAL_EITAN_PIN", "TEAM_PORTAL_AUTH_SECRET", "TEAM_PORTAL_CRON_SECRET", "TEAM_PORTAL_MAIN_SYNC_SECRET"]) {
